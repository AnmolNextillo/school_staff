...
const AnnoucementDetail = ({ navigation, route }) => {
    ...
    const responseAnnouncementDetail = useSelector((state) => state.getAnnouncementDetailReducer.data)
    ...
    useEffect(() => {
        console.log("responseAnnouncementDetail re===> ", responseAnnouncementDetail)
        if (responseAnnouncementDetail != null && responseAnnouncementDetail.status === 1) {
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flex: 1 }}>
                ...
                <View style={styles.viewStyle}>
                    <Text style={{ fontWeight: '600' }}>Title: {announcementData != null && announcementData.title}</Text>
                    <Text style={{ fontWeight: '400', marginTop: 8 }}>Subject: <Text style={{ fontWeight: "600" }}>{announcementData != null && announcementData.subject}</Text></Text>
                    <Text style={{ fontWeight: '400', marginTop: 8 }}>Description : <Text style={{ fontWeight: "600" }}>{announcementData != null && announcementData.description}</Text></Text>
                    <Text style={{ fontWeight: '400', marginTop: 8 }}>Date : <Text style={{ fontWeight: "600" }}>{announcementData != null && announcementData.date}</Text></Text>
